...
Let's look at some water quality data for the twin cities. Run the following code:
...
### Exercise 3: Map design

**Create a map with at least two different geometries, and add labels, a legend, a title, a scale bar, and credits to your map**
