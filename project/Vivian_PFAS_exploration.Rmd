...
wells = c("Well", "Well-DOmestic",	"Well-Domestic","Well-Monitoring", "Well-Observation", "Well-Other","Well-PubWtrSub")
...
pfas %>%
  ...
  mutate(detected = ifelse(DETECT_FLAG == "Y", TRUE, FALSE)) %>%
  group_by(year(`SAMPLE DATE`), commonName, `SYS LOC CODE`) %>%
