...
wells = c("Well", "Well-DOmestic",	"Well-Domestic","Well-Monitoring", "Well-Observation", "Well-Other", "Well-Piezometer", "Well-PubWtrSub")
...
ggplot(pfba_compare_yes, aes(x = percent_yes)) + 
  geom_density()
```
