...
Overall map of PFAS samples and whether or not there was detection. This includes all types of samples. 
...
ggplot()+
  geom_sf(data = counties_cropped, color = "navajowhite", fill = "ivory", size = 0.5)+
  geom_sf(data = well %>% filter(DETECT_FLAG == "Y"), size= 1, aes(color = commonName), alpha=0.5)
